...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("Ffb_h_DeviceID")
        .allowlist_function("Ffb_h_Type")
        .allowlist_function("Ffb_h_Packet")
        .allowlist_function("Ffb_h_EBI")
        .allowlist_function("Ffb_h_Eff_Report")
        .allowlist_function("Ffb_h_Eff_Const")
        .allowlist_function("Ffb_h_Eff_Ramp")
        .allowlist_function("Ffb_h_EffOp")
        .allowlist_function("Ffb_h_DevCtrl")
        .allowlist_function("Ffb_h_Eff_Period")
        .allowlist_function("Ffb_h_Eff_Cond")
        .allowlist_function("Ffb_h_DevGain")
        .allowlist_function("Ffb_h_Eff_Envlp")
        .allowlist_function("Ffb_h_EffNew")
        .allowlist_function("Ffb_h_Eff_Constant")
